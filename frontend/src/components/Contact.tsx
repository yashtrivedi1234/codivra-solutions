...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="relative py-24 md:py-32 bg-[#0A0F1C] overflow-hidden">
            ...
            <div className="lg:col-span-2 space-y-8">
                      ...
                      <div className="flex items-start gap-5">
                        ...
                        <div className="flex-1 pt-1">
                          ...
                          {item.href ? (
                            <a 
                              href={item.href} 
                              className="text-white text-base font-bold hover:text-[#00D9FF] transition-colors block leading-relaxed"
                            >
                              {item.value}
                            </a>
                          ) : (
                            <span className="text-white text-base font-bold leading-relaxed block">
                              {item.value}
                            </span>
                          )}
                        </div>
              ...
              <AnimatedSection>
                <motion.div
                  ...
                  className="bg-gradient-to-br from-[#00D9FF]/10 to-[#0066FF]/10 backdrop-blur-sm border-2 border-[#00D9FF]/30 rounded-2xl p-6"
                >
                  <div className="grid grid-cols-3 gap-4">
                    {stats.map((stat, idx) => (
                      <div key={stat.label} className="text-center">
                        <div className="w-12 h-12 bg-gradient-to-br from-[#00D9FF]/20 to-[#0066FF]/20 rounded-xl flex items-center justify-center mx-auto mb-3">
            ...
            <div className="lg:col-span-3">
              <AnimatedSection delay={0.2}>
                <div className="relative">
                  ...
                  {/* Form Card */}
                  <div className="relative bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl border-2 border-white/20 rounded-[2rem] p-8 lg:p-12">
                    {isSubmitted ? (
                      <motion.div
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="relative w-24 h-24 bg-gradient-to-br from-[#00D9FF] to-[#0066FF] rounded-full flex items-center justify-center shadow-[0_0_40px_rgba(0,217,255,0.5)]">
                            <CheckCircle className="w-12 h-12 text-white" strokeWidth={3} />
                          </div>
                        </motion.div>
                        
                        <h3 
                          className="text-3xl md:text-4xl font-black text-white mb-4 uppercase tracking-wide" 
                          style={{ fontFamily: "'Oswald', sans-serif" }}
                        >
                          Message Sent!
                        </h3>
                        <p className="text-white/70 mb-8 text-lg max-w-md" style={{ fontFamily: "'Crimson Pro', serif" }}>
                        ...
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                          <Button
                            ...
                            className="bg-gradient-to-r from-[#00D9FF] to-[#0066FF] text-white font-black px-8 py-6 rounded-xl text-base uppercase tracking-wider shadow-[0_0_30px_rgba(0,217,255,0.4)] hover:shadow-[0_0_50px_rgba(0,217,255,0.6)]"
                          >
                      ...
                      <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`w-full h-14 px-4 rounded-xl bg-white/5 border-2 border-white/20 text-white font-semibold focus:border-[#00D9FF] focus:ring-0 focus:outline-none transition-all ${
                        ...
                        <div>
                          ...
                          <Textarea
                            ...
                            rows={6}
                            className={`bg-white/5 border-2 border-white/20 text-white placeholder:text-white/40 rounded-xl resize-none focus:border-[#00D9FF] focus:ring-0 focus:bg-white/10 font-semibold transition-all ${
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                          <Button
                            type="submit"
                            disabled={isSubmitting}
                            className="w-full bg-gradient-to-r from-[#00D9FF] to-[#0066FF] text-white font-black py-7 text-lg rounded-xl shadow-[0_0_30px_rgba(0,217,255,0.4)] hover:shadow-[0_0_50px_rgba(0,217,255,0.6)] transition-all duration-300 group uppercase tracking-wider"
                          >
                            {isSubmitting ? (
